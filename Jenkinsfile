pipeline {
    ...
    environment {
        // Nom de l'image Docker (compte DockerHub : medbenrhaiem)
        DOCKER_IMAGE = "medbenrhaiem/angular-app"
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'master', url: 'https://github.com/Mohamed-BenRhaiem/datacamp_docker_angular.git'
            }
        }
